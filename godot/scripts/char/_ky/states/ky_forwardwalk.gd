class_name KyState_ForwardWalk extends CharacterState

 # Set basic variables here!
func _init(calling_char: Character = null):
	STATE_NAME = "Ky Walk Forward"
	STATE_ANIMATION_NAME = "walk forward"
...
func determine_next_state() -> CharacterState:
	...
	elif not CALLING_CHARACTER.input.buffer.read_action([["6", 0]]):
